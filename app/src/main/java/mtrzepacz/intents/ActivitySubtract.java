...
public class ActivitySubtract extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(getApplicationContext(),"substract activity", Toast.LENGTH_LONG).show();
        Intent intent = new Intent();
        intent.putExtra(getResources().getString(R.string.result),result);
        intent.putExtra(getResources().getString(R.string.operation), getResources().getString(R.string.subtract));
